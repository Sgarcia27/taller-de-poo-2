...
class PostListView(PermissionMixin, ListViewMixin, ListView):
...
class PostCreateView(PermissionMixin, CreateViewMixin, CreateView):
    model = Cargo
...
class PostUpdateView(PermissionMixin, UpdateViewMixin, UpdateView):
    model = Cargo
...
class PostDeleteView(PermissionMixin, DeleteViewMixin, DeleteView):
    model = Cargo
