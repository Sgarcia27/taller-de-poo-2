...
class BrandMedicineListView(PermissionMixin, ListViewMixin, ListView):
...
class BrandMedicineCreateView(PermissionMixin, CreateViewMixin, CreateView):
    model = MarcaMedicamento
...
class BrandMedicineUpdateView(PermissionMixin, UpdateViewMixin, UpdateView):
    model = MarcaMedicamento
...
class BrandMedicineDeleteView(PermissionMixin, DeleteViewMixin, DeleteView):
    model = MarcaMedicamento
