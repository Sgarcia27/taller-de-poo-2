...
class MedicationTypeListView(PermissionMixin, ListViewMixin, ListView):
...
class MedicationTypeCreateView(PermissionMixin, CreateViewMixin, CreateView):
    model = TipoMedicamento
...
class MedicationTypeUpdateView(PermissionMixin, UpdateViewMixin, UpdateView):
    model = TipoMedicamento
...
class MedicationTypeDeleteView(PermissionMixin, DeleteViewMixin, DeleteView):
    model = TipoMedicamento
