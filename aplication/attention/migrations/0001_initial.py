    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dia_semana', models.CharField(choices=[('LUNES', 'Lunes'), ('MARTES', 'Martes'), ('MIERCOLES', 'Miércoles'), ('JUEVES', 'Jueves'), ('VIERNES', 'Viernes'), ('SABADO', 'Sábado'), ('DOMINGO', 'Domingo')], max_length=10, unique=True, verbose_name='Día de la Semana')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('examenes_medicos', models.ManyToManyField(blank=True, to='attention.examensolicitado', verbose_name='Exámenes Médicos')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('especialista', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='citas_medicas', to='core.especialidad', verbose_name='Especialista')),
