...
class CitaMedica(models.Model):
    especialista = models.ForeignKey(Especialidad, on_delete=models.PROTECT, verbose_name="Especialista", related_name="citas_medicas")
...
class Pago(models.Model):
    ...
    examenes_medicos = models.ManyToManyField(ExamenSolicitado, blank=True, verbose_name="Exámenes Médicos")
    ...
    def __str__(self):
        return f"{self.paciente.nombre} - {self.costo_atencion.total} - {self.metodo_pago}"
